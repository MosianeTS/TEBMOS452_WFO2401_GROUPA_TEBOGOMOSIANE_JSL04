...
let typeDecision = (userPreference == 'Regular') ? "Regular" : (userPreference == 'Sugar-free') ? "Sugar-free" : "Regular"
console.log(`This guy's preferred type is ${typeDecision}`);
...
let stockDecision =  (cansLeft < 5) ? 'Time to restock' : 'We are stocked'
console.log(stockDecision)
...
let drinkDecision =  (heartRate < 100) ? 'Boost needed' : 'Energy levels are high'
...
let tempDecision = (currentTemp > 5) ? 'Needs a cooler': 'Chilled to perfection'
console.log(tempDecision);
...
let currentHour = 15; 
let hourDecision = (currentHour > 7 && currentHour < 24) ? 'Unleash the beast': 'Better stick to water'
console.log(hourDecision)
